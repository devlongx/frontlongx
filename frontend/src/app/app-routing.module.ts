    ...
    children: [
      ...
      },
      {
        ...
        children:[
          ...
          {path:"clip" , component:ClipWalletComponent},
          {path:"deposit" , component:WalletDepositComponent},
          {path:"withdraw" , component:WalletDepositComponent},
          {path:"retirar" , component:WithdrawComponent},
          {path:"usdt-retirar" , component:UsdtWithdrawComponent},
          {path:"usdt-deposit" , component:UsdtDepositComponent},
        ]
      },
      {
        path: 'comprar-vender',
